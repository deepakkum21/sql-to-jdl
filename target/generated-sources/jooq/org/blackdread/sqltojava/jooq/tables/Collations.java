...
import org.blackdread.sqltojava.jooq.enums.CollationsPadAttribute;
import org.blackdread.sqltojava.jooq.tables.records.CollationsRecord;
...
public class Collations extends TableImpl<CollationsRecord> {
    ...
    private static final long serialVersionUID = -591626888;
     ...
     */
    public final TableField<CollationsRecord, CollationsPadAttribute> PAD_ATTRIBUTE = createField("PAD_ATTRIBUTE", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(org.blackdread.sqltojava.jooq.enums.CollationsPadAttribute.class), this, "");

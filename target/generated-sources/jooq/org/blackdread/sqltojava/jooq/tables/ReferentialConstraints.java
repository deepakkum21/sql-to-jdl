...
import org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsDeleteRule;
import org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsMatchOption;
import org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsUpdateRule;
import org.blackdread.sqltojava.jooq.tables.records.ReferentialConstraintsRecord;
...
public class ReferentialConstraints extends TableImpl<ReferentialConstraintsRecord> {
    ...
    private static final long serialVersionUID = 235579244;
     ...
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsMatchOption> MATCH_OPTION = createField("MATCH_OPTION", org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsMatchOption.class), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.UPDATE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsUpdateRule> UPDATE_RULE = createField("UPDATE_RULE", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsUpdateRule.class), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.DELETE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsDeleteRule> DELETE_RULE = createField("DELETE_RULE", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(org.blackdread.sqltojava.jooq.enums.ReferentialConstraintsDeleteRule.class), this, "");

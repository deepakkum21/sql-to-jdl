...
import org.blackdread.sqltojava.jooq.enums.ColumnsColumnKey;
import org.blackdread.sqltojava.jooq.tables.records.ColumnsRecord;
...
public class Columns extends TableImpl<ColumnsRecord> {
    ...
    private static final long serialVersionUID = 2105372663;
     ...
     */
    public final TableField<ColumnsRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.TABLE_SCHEMA</code>.
     */
    public final TableField<ColumnsRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.TABLE_NAME</code>.
     */
    public final TableField<ColumnsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<ColumnsRecord, ColumnsColumnKey> COLUMN_KEY = createField("COLUMN_KEY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(org.blackdread.sqltojava.jooq.enums.ColumnsColumnKey.class), this, "");
